...
REQUIRED_FILES = [
    ...
    "docs/model-governance-validation-run-kit/SOURCE_MAP.md",
    "docs/finreglab-framework-implementation-crosswalk.md",
    "docs/credit-union-ai-vendor-risk-run-kit/README.md",
    "docs/credit-union-ai-vendor-risk-run-kit/SOURCE_MAP.md",
    "docs/credit-union-ai-vendor-risk-run-kit/IMPLEMENTATION_PLAN.md",
    ...
    "data/synthetic/credit-union-vendor-risk/README.md",
...
REQUIRED_TERMS = {
    ...
    "docs/model-governance-validation-run-kit/README.md": [
        ...
        "not a statute, regulation, agency rule, or supervisory issuance",
    ],
    "docs/model-governance-validation-run-kit/SOURCE_MAP.md": [
        "Source-to-Control Map",
        "Binding law or regulation where applicable",
    ...
    "data/synthetic/credit-union-vendor-risk/README.md": [
        ...
        "establish institutional adoption",
    ],
    "governance/model-inventory-template.md": [
