...
| Vendor model oversight | SR 26-2 includes vendor-product validation; FinRegLab discusses information and oversight constraints | Six linked vendor contracts, evidence and relationship validation, synthetic scenarios, and deterministic vendor reports are implemented | The repository has no real vendor evidence, institution-specific calibration, production use, or independent review |
