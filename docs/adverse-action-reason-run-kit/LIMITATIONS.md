...
- Its source-to-rendered-notice check reconciles controlled synthetic notice
  segments to reason records; it does not determine whether real
  applicant-facing language is clear, accurate in context, or legally
  sufficient.
